...
(BER). Working group at ISO on ASN.1 (London, \oldstylenums{1997}).
...
\begin{itemize*}
  ...
  \item \textit{Design and Analysis of Purely Functional Programs}
    ...
    Logique et d'Épistémologie}, \oldstylenums{2012}).
  ...
  \item Translator from/to French/Spanish of the love poems
    ...
    by Pablo Neruda (Gallimard Po\'esie, Paris, \oldstylenums{1998}),
    \emph{Las granadas} by Paul Val\'ery, (Ediciones Rilke, Madrid,
    \oldstylenums{2016}), \textit{Rimes} by Gustavo Adolfo B\'ecquer
    (L'Harmattan, Paris, \oldstylenums{2024})).
